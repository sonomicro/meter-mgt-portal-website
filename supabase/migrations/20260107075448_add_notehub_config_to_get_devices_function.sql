/*
  # Add notehub_config to get_devices_with_status function
  
  1. Changes
    - Add notehub_config JSONB column to the get_devices_with_status function return type
    - Include notehub_config in the SELECT statement
  
  2. Notes
    - This allows the frontend to display device configuration details
    - The function already includes other device fields
*/
