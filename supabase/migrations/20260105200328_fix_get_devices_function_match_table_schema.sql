/*
  # Fix get_devices_with_status function to match table schema exactly
  
  1. Changes
    - Add missing columns: install_date, alert_config, alias
    - Ensure all columns from devices table are included in the function result
